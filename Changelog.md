...
## Changes since 1.5.7 
* To address the bugs in https://github.com/flutter/flutter/issues/16604, the flutter tool will now always run Gradle or Xcode when asked to run/build an application. Previously we attempted to avoid rebuilds when we believed that the underlying application should not have changed.
