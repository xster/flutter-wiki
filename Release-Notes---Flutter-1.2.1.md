...
To more fully round-out Flutter's animation support, this release adds several more of [the standard easing functions](easings.net):
...
You can see [the full list of issues](https://github.com/flutter/flutter/wiki/Release-Notes---Changes-in-1.2.0) addressed in this release.
