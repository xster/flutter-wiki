...
If your UIApplicationDelegate is not already a sub-class of a custom `UIResponder`, make
it inherit from `FlutterAppDelegate`:
...
Make your app delegate implement the `FlutterAppLifeCycleProvider` protocol:
```objectivec
:
#import <Flutter/Flutter.h>
:
